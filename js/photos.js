...
window.TRIPS = [
  ...
  },
  {
    ...
    photos: [
      ...
      { src: "photos/placeholders/la-7.svg", w: 1000, h: 1000, alt: "Placeholder frame — replace with your photo", caption: "Wilshire, mid-afternoon" },
      { src: "photos/placeholders/la-8.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "The basin from the third floor" },
      { src: "photos/placeholders/la-9.svg", w: 900, h: 1200, alt: "Placeholder frame — replace with your photo", caption: "Travertine and shadow" },
      { src: "photos/placeholders/la-10.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "Last light on the plaza" }
    ],
    beats: [
  ...
  },
  {
    ...
    photos: [
      ...
      { src: "photos/placeholders/chi-7.svg", w: 1000, h: 1000, alt: "Placeholder frame — replace with your photo", caption: "The lake, frozen out to the crib" },
      { src: "photos/placeholders/chi-8.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "Wacker at dusk" },
      { src: "photos/placeholders/chi-9.svg", w: 900, h: 1200, alt: "Placeholder frame — replace with your photo", caption: "Snow coming across the river" },
      { src: "photos/placeholders/chi-10.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "Blue hour, west loop" }
    ],
    beats: [
  ...
  },
  {
    ...
    photos: [
      ...
      { src: "photos/placeholders/ldnpar-7.svg", w: 1000, h: 1000, alt: "Placeholder frame — replace with your photo", caption: "The pond, second morning" },
      { src: "photos/placeholders/ldnpar-8.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "Willows over the water" },
      { src: "photos/placeholders/ldnpar-9.svg", w: 900, h: 1200, alt: "Placeholder frame — replace with your photo", caption: "The garden path" },
      { src: "photos/placeholders/ldnpar-10.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "Giverny, going grey" }
    ],
    beats: [
  ...
  },
  {
    ...
    photos: [
      ...
      { src: "photos/placeholders/nash-7.svg", w: 1000, h: 1000, alt: "Placeholder frame — replace with your photo", caption: "Ridge line off Highway 96" },
      { src: "photos/placeholders/nash-8.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "The Harpeth in low water" },
      { src: "photos/placeholders/nash-9.svg", w: 900, h: 1200, alt: "Placeholder frame — replace with your photo", caption: "Late summer, Franklin" },
      { src: "photos/placeholders/nash-10.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "First light, Radnor" }
    ],
    beats: [
  ...
  },
  {
    ...
    photos: [
      ...
      { src: "photos/placeholders/bigsur-7.svg", w: 1000, h: 1000, alt: "Placeholder frame — replace with your photo", caption: "South from Bixby" },
      { src: "photos/placeholders/bigsur-8.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "The cove at slack tide" },
      { src: "photos/placeholders/bigsur-9.svg", w: 900, h: 1200, alt: "Placeholder frame — replace with your photo", caption: "Fog on the ridge road" },
      { src: "photos/placeholders/bigsur-10.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "Pfeiffer, late afternoon" }
    ],
    beats: [
  ...
  },
  {
    ...
    photos: [
      ...
      { src: "photos/placeholders/nyc-7.svg", w: 1000, h: 1000, alt: "Placeholder frame — replace with your photo", caption: "Sixth Avenue in the snow" },
      { src: "photos/placeholders/nyc-8.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "The park after the storm" },
      { src: "photos/placeholders/nyc-9.svg", w: 900, h: 1200, alt: "Placeholder frame — replace with your photo", caption: "Uptown, white sky" },
      { src: "photos/placeholders/nyc-10.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "Hudson light, late day" }
    ],
    beats: [
  ...
  },
  {
    ...
    photos: [
      ...
      { src: "photos/placeholders/jtree-7.svg", w: 1000, h: 1000, alt: "Placeholder frame — replace with your photo", caption: "Dusk over the boulders" },
      { src: "photos/placeholders/jtree-8.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "Cap Rock, first stars" },
      { src: "photos/placeholders/jtree-9.svg", w: 900, h: 1200, alt: "Placeholder frame — replace with your photo", caption: "The cholla garden going dark" },
      { src: "photos/placeholders/jtree-10.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "Last colour on the ridge" }
    ],
    beats: [
  ...
  },
  {
    ...
    photos: [
      ...
      { src: "photos/placeholders/bay-7.svg", w: 1000, h: 1000, alt: "Placeholder frame — replace with your photo", caption: "The hills gone gold" },
      { src: "photos/placeholders/bay-8.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "Fog over the gate" },
      { src: "photos/placeholders/bay-9.svg", w: 900, h: 1200, alt: "Placeholder frame — replace with your photo", caption: "Berkeley, late September" },
      { src: "photos/placeholders/bay-10.svg", w: 1200, h: 900, alt: "Placeholder frame — replace with your photo", caption: "Twin Peaks at blue hour" }
    ],
    beats: [
